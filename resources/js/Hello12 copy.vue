...
-->
	...
	<!-- reference sidebar-pro directory -->
        <div v-bind:class="['page-wrapper', 'default-theme', 'sidebar-bg', 'bg1', 'toggled', {'pinned': isPin}, {'sidebar-hovered': isSidebarHovered}]">    
            <nav id="sidebar" class="sidebar-wrapper" ref="sidebar">
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-item sidebar-header d-flex flex-nowrap">
                        <div class="user-pic">
                            <img class="img-responsive img-rounded" src="./sidebar-pro/img/user.jpg" alt="User picture">
                        </div>
                        <div class="user-info">
                    ...
                    <div class="sidebar-item sidebar-menu">
                        <ul id="sidebar-menu-items">
                            ...
                            <li v-bind:class="['sidebar-dropdown', {'active': isSidebarDropdown[2]}]">
                        ...
                        <div class="dropdown-menu messages" aria-labelledby="dropdownMenuMessage">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="message-content">
                                    <div class="pic">
                                        <img src="./sidebar-pro/img/user.jpg" alt="">
                                    </div>
                                    <div class="content">
...
export default {
	...
	data() {
		return {
            ...
            //eventnameMouseover: 'mouseover',
            //eventnameMouseout: 'mouseout',
